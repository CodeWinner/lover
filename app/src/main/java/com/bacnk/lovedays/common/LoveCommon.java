...
public class LoveCommon {
    public static final String TABLE_INFO_PERSONAL_NAME = "INFO_PERSONAL";
    public static final String PERSONAL_ID = "ID";
    public static final String PERSONAL_NAME = "NAME";
    public static final String PERSONAL_BIRTH_DAY = "BIRTH_DAY";
    public static final String PERSONAL_SEX = "SEX";
    public static final String PERSONAL_IMAGE = "IMAGE";
    public static final String PERSONAL_COLOR_BODER_CODE = "COLOR_BODER_CODE";
    public static final String PERSONAL_COLOR_TEXT = "COLOR_TEXT";


    public static final String TABLE_INFO_APP = "INFO_APP";
    public static final String APP_START_DAY = "START_DAY";
    ...
    public static final String KEY_SHOWCASE_START_DATE =  "KEY_SHOWCASE_START_DATE";
    public static final String KEY_SHOWCASE_LOVE_MESS =  "KEY_SHOWCASE_LOVE_MESS";
    public static final String KEY_RATED_APP =  "KEY_RATED_APP";
    public static final String KEY_UPGRATE_APP =  "KEY_UPGRATE_APP";
    public static final String KEY_VERSION_APP =  "KEY_VERSION_APP";
    public static final String KEY_UPDATE_TITLE_TOP =  "KEY_UPDATE_TITLE_TOP";
    public static final String KEY_UPDATE_TITLE_BOTTOM =  "KEY_UPDATE_TITLE_BOTTOM";
    ...
    public static final int BACH_DUONG = 1;
    public static final int KIM_NGUU = 2;
    public static final int SONG_TU = 3;
    public static final int CU_GIAI = 4;
    public static final int SU_TU = 5;
    public static final int XU_NU = 6;
    public static final int THIEN_BINH = 7;
    public static final int BO_CAP = 8;
    public static final int NHAN_MA = 9;
    public static final int MA_KET = 10;
    ...
    public static final String IMAGE_BACKGROUND_NAME = "LoveDayImage_background";
    public static final String EXTENDTION_PNG = ".png";
    public static final int REQUEST_SELECT_PICTURE_FOR_FRAGMENT = 0x02;

    public static final String KEY_TYPE_NOTIFICATION = "KEY_TYPE_NOTIFICATION";
    // SOUND background
    public static String URI_SOUND;

    // Key mapp message
    public static final String KEY_LOCAL_LANGUAGE = "KEY_LOCAL_LANGUAGE";
    public static final String KEY_LOCAL_TITLE = "KEY_LOCAL_TITLE";
    public static final String KEY_LOCAL_BODY = "KEY_LOCAL_BODY";

    public static boolean MENU_ACTIVITY = false;
